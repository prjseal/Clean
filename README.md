...
# Add Clean package
dotnet add "MyProject" package Clean --version 7.0.0-preview12
...
dotnet add "MyProject" package Clean.Core --version 7.0.0-preview12
```
...
dotnet new install Umbraco.Community.Templates.Clean::7.0.0-preview12 --force
