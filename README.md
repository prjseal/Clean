...
dotnet new install Umbraco.Templates::17.5.1 --force
...
# Add Clean package
dotnet add "MyProject" package Clean --version 7.0.8
...
dotnet add "MyProject" package Clean.Core --version 7.0.8
```
...
dotnet new install Umbraco.Community.Templates.Clean::7.0.8 --force
