...
|------|--------|---------|-------------|
| **CI Build** | `X.Y.Z-ci.bNNNNNNN` | `7.0.0-ci.b0000123` | Automatic on every PR |
...
```
1.0.0-alpha.1 < 1.0.0-beta.1 < 1.0.0-rc.1 < 1.0.0 < 1.0.1-ci.b0000001
```

**Important**: CI builds (`-ci.bNNNNNNN`) sort **after** stable releases, ensuring they don't interfere with production package resolution.
...
- Version format: `{latest-stable}-ci.b{ci-build-number}` (7-digit zero-padded with 'b' prefix)
- Example: `7.0.0-ci.b0000123`
- The 'b' prefix ensures SemVer compliance (alphanumeric identifiers allow leading zeros)
...
2. Append `-ci.b{ci-build-number}` (7-digit zero-padded with 'b' prefix) to create build version
...
- PR #45, Build #123: `7.0.0-ci.b0000123`
- PR #46, Build #124: `7.0.0-ci.b0000124`
...
**Example**:
- PR #45 and PR #46 both use `7.0.0-ci.b0000123`
