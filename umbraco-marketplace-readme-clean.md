...
- **Multi-version Support** - Works on all versions since Umbraco 8. Latest version targets Umbraco 18 (.NET 10)
...
> **✨ Note**: As of version 7.0.0, the template now supports periods in project names (e.g., `Company.Website`).
